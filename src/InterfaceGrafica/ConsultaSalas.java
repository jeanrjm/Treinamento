...
public class ConsultaSalas extends javax.swing.JFrame {
    ...
    private void listarSalasCombos() throws Exception {
        listaSalas.removeAllItems();

        Espaco[] lista = new Evento().getSalas();

        listaSalas.addItem("Selecione uma sala");
        ids = new int[lista.length];

        for (int i = 0; i < lista.length; i++) {
            String nome = lista[i].getNome();
            
            listaSalas.addItem(lista[i].getNome());
    ...
    public void updatePessoaNaTabela() {
        ...
        int indexSelecionado = listaSalas.getSelectedIndex();
    ...
    public ConsultaSalas() {
        ...
        listaSalas.addActionListener(new ActionListener() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(listaSalas, javax.swing.GroupLayout.PREFERRED_SIZE, 172, javax.swing.GroupLayout.PREFERRED_SIZE))
