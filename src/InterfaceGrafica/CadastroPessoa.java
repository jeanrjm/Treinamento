...
public class CadastroPessoa extends javax.swing.JFrame {
    ...
    public CadastroPessoa() {
        ...
        campoSobrenome.addKeyListener(new KeyAdapter() {
            public void keyTyped(KeyEvent e) {
                descrStatus.setText("");
            }
        });
        ...
        cadastrarPessoa.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(!campoNome.getText().isEmpty() && !campoSobrenome.getText().isEmpty()){
                    try{
                        new Evento().cadastrarNovaPessoa(campoNome.getText(), campoSobrenome.getText());
                        descrStatus.setText(campoNome.getText()+" "+campoSobrenome.getText()+" cadastrado com sucesso");
                        campoNome.setText("");
